...
We have now gathered enough data to start answering the research question you selected at the beginning of the term (seems like ages ago!). You designed a classification system in tutorials, and individually gathered data on lots of countries (111 so far to be exact). And the results are really good; your classification correlates at 0.79 with [Freedom House][FH] and at 0.76 with [Polity IV][Polity]. This is not bad at all; Polity IV and Freedom House themselves correlate at 0.89, which is only slightly higher. Professionals do not always agree about whether a country is democratic or not. These results make me feel benevolent; perhaps I should restore some of your points!
...
![](https://github.com/xmarquez/RCE-2015/blob/master/Preliminary_description_of_data_files/figure-html/unnamed-chunk-1-1.png?raw=true) 
...
![](https://github.com/xmarquez/RCE-2015/blob/master/Preliminary_description_of_data_files/figure-html/unnamed-chunk-2-1.png?raw=true) 
