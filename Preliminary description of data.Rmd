...
fh <- fh <- read.csv("../../../Data/fh.19722014.csv")
...
cor.fh <- round(cor(data_tv$s,data_tv$fh,use="pairwise.complete"),2)
cor.polity <- round(cor(data_tv$s,data_tv$polity2,use="pairwise.complete"),2)
...
```{r, echo=FALSE,warning=FALSE,message=FALSE, cache=TRUE,fig.height=25}
